defmodule Evaluation do
  ...
  def evaluate({:quot, numerator, denominator}, _enironment) do
  ...
  def reduce({:quot, _numerator, 0}) do :undefined end
  def reduce({:quot, 0, _denominator}) do {:num, 0} end
  def reduce({:quot, numerator, denominator}) when rem(numerator, denominator) == 0 do
    {:num, divide(numerator, denominator)}
  end
  def reduce({:quot, numerator, denominator}) do
    gcd = Integer.gcd(numerator, denominator)
    {:quot, trunc(numerator/gcd), trunc(denominator/gcd)}
  end
